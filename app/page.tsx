...
export default function Home() {
  const [headerTerminalTransaction, setHeaderTerminalTransaction] =
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Header
        onTerminalTransaction={handleHeaderTerminalTransaction}
        networkConfig={networkConfig}
      />
      <main className="container mx-auto py-6 px-4 flex-1">
        <section className="mb-6" aria-labelledby="page-title">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
            ...
            <NetworkStatus
              ...
              onConfigureClick={() => setIsNetworkConfigOpen(true)}
            />
          </div>
        </section>

        <Iso8583Simulator
          headerTerminalTransaction={headerTerminalTransaction}
          networkConfig={networkConfig}
        />
      </main>
